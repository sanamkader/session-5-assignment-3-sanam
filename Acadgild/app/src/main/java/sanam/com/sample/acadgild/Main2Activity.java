package sanam.com.sample.acadgild;
...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (acadgilddata==null){
            ...
            tv_mentorname.setText("Mentor is Paramvir Singh");

        }
        else if (acadgildmessage==1){
            tv_mentorname.setText("Mentor is Mentor 2");

        }
        else if (acadgildmessage==2){
            tv_mentorname.setText("Mentor is Mentor 3");

        }
        else if (acadgildmessage==3){
            tv_mentorname.setText("Mentor is Harsha");
